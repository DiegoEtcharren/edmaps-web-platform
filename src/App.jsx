...
export default function App() {
  return (
    <div className="min-h-screen bg-[#0F3A5F] text-slate-100 flex flex-col font-sans select-none antialiased">
      ...
      <footer className="bg-slate-950 border-t border-white/5 py-12 px-6 md:px-12 text-slate-400">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center space-x-3">
            <div className="w-8 h-8 rounded-lg bg-slate-900 border border-white/10 flex items-center justify-center">
              <Cpu className="w-4 h-4 text-industrial-green animate-pulse" />
            </div>
            <div className="font-sans font-black tracking-widest text-lg flex items-center">
              <span className="text-white">EDM</span>
              <span className="relative inline-block text-white">
                A
                <span className="absolute left-[-2px] right-[-2px] top-[58%] h-[3px] bg-industrial-green transform -rotate-[15deg] rounded-full shadow-[0_0_8px_rgba(15,157,88,0.8)]"></span>
              </span>
          ...
          <div className="text-center md:text-right">
            ...
            <span className="text-xs text-slate-400 font-semibold flex items-center justify-center md:justify-end">
              <Shield className="w-4 h-4 text-industrial-green mr-1.5 inline" />
              <span>Conectividad de Planta Certificada ISO 27001</span>
            </span>
          </div>
        </div>

        {/* Dynamic Legal Copyright and Info */}
